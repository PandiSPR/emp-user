...
<div class="sidebar">
  ...
  <a href="{{ route('profile') }}"><b> One-to-One-Profile</b></a>
...
<div class="container mt-3 mb-5">
  ...
  <tbody>
    ...
    <tr>
      ...
      <a class="btn btn-warning" href="{{ url('user/view', [$user->id]) }}">View</a>
       &nbsp
      ...
      <button type="submit" class="btn btn-info" onclick="location.href='{{ route('profile') }}'"> One-To-One </button>&nbsp;
